...
<div class="main single-ordinateur">
  ...
  <?php if (have_posts()) : ?>
    ...
    <?php
      ...
      $prix_produit = $custom['prix_ordinateur'][0];
      $processeur_produit = $custom['processeur_ordinateur'][0];
      $chipset_produit = $custom['chipset_ordinateur'][0];
      $ram_produit = $custom['ram_ordinateur'][0];
      $stock_produit = $custom['stock_ordinateur'][0];
    ?>
